...
2.  **Preparing `access.csv`**:

Populate `access.csv` with details from your data files:

``` r
prep_access()
```

After running this, you can manually add URLs or DOIs where the data can be accessed.
