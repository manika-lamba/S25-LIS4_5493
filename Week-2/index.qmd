...
::: notes
We will start this lecture by revisiting this slide from last week. We
learnt how data shared by platforms can generate biases in algorithms
that we use daily through social networking apps (Facebook, X,
Instagram, etc.) or just searching through internet.
:::
...
::: notes
In the next module, we will take a deep dive into data feminism and algorithmic confounding. 
:::
