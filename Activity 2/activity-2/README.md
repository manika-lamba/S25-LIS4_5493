...
* Step 3: [Connecting our local repository to github](./github_sync.md) - Backup! Making our code available to the world.
* Step 4: [Subsequent updates](./updates.md) - Now we are set up, the workflow is easy.
